...
// ── Status config ─────────────────────────────────────────────
const STATUS = {
    paid:       { label: 'Paid',       color: '#3B82F6', bg: '#EFF5FF', icon: '✓',  step: 1 },
    processing: { label: 'Processing', color: '#D97706', bg: '#FFF8EF', icon: '⚙',  step: 2 },
    shipped:    { label: 'Shipped',    color: '#8B5CF6', bg: '#F5F0FF', icon: '✈',  step: 3 },
    delivered:  { label: 'Delivered',  color: '#27AE60', bg: '#EDFFF4', icon: '✦',  step: 4 },
    cancelled:  { label: 'Cancelled',  color: '#C0392B', bg: '#FFF5F5', icon: '✕',  step: 0 },
};
